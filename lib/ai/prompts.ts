...
export function buildCapabilityClassifierSystemPrompt(): string {
  return [
    ...
    "- \"out_of_scope\" — a genuine request about something unrelated to health entirely (e.g. \"what's the weather in Lagos this week?\", \"write my resignation letter\", \"what's a good jollof rice recipe?\"). Distinct from \"general_conversation\" below: this is an actual request for something else, not aimless chat.",
    "- \"greeting\" — the message is a greeting and nothing else (e.g. \"Hi\", \"Hello\", \"Hey Beca\", \"Good morning\").",
    "- \"farewell\" — the message is a goodbye and nothing else (e.g. \"Bye\", \"See you\", \"I have to go now\").",
    "- \"thanks\" — the message is an expression of thanks or appreciation and nothing else (e.g. \"Thanks\", \"Thank you\", \"That helped\").",
    "- \"help_request\" — the user is asking what Beca can do or help with, not asking a specific health question yet (e.g. \"What can you help me with?\", \"What do you do?\").",
    "- \"general_conversation\" — casual conversation with no real request in it and no health content (e.g. \"How are you?\", \"lol\", \"what's up\") — distinct from \"out_of_scope\" above, which is an actual request about something else.",
